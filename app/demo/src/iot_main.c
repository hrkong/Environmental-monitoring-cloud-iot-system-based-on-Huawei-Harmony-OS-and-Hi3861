...
#define CN_IOT_SERVER  "tcp://a2f62fc811.iot-mqtts.cn-north-4.myhuaweicloud.com:1883"
#define CONFIG_COMMAND_TIMEOUT  10000L
#define CN_KEEPALIVE_TIME 50
#define CN_CLEANSESSION 1
#define CN_HMAC_PWD_LEN 65
#define CN_EVENT_TIME "1970000100"
#define CN_CLIENTID_FMT "%s_0_0_%s"
...
{
    IOT_LOG_DEBUG("Connection lost:cause by:%s\r\n",cause == NULL? "Unknown":cause);
    return;
}
...
static hi_void MainEntryProcess(hi_void)
{
    ...
    MQTTClient_SSLOptions ss_opts=MQTTClient_SSLOptions_initializer;
